...
class NewsService {
  ...
  Future<List<NewsModel>> _fetchFromFallback(String country, String? category) async {
    try {
      ...
      final targetCountry = supportedCountries.contains(country) ? country : 'us';
      ...
      if (category != null && standardCategories.contains(category)) {
        url = '$fallbackUrl/top-headlines/category/$category/$targetCountry.json';
      } else {
  ...
  List<NewsModel> _getSampleNews() {
    ...
    return [
      NewsModel(
        ...
        description: 'Innovators from around the world gather to discuss the future of AI and sustainable technology.',
        urlToImage: 'https://images.unsplash.com/photo-1505373877841-8d25f7d46678?w=800',
      ...
      NewsModel(
        ...
        description: 'United Nations delegates have agreed on a comprehensive framework to combat global warming.',
        urlToImage: 'https://images.unsplash.com/photo-1569163139599-0f4517e36b51?w=800',
      ...
      NewsModel(
        ...
        description: 'Astronauts from three different space agencies arrived at the ISS today.',
      ...
      NewsModel(
        ...
        description: 'FIFA has officially announced the final list of host cities for the upcoming World Cup.',
        urlToImage: 'https://images.unsplash.com/photo-1518091043644-c1d4457512c6?w=800',
      ...
      NewsModel(
        ...
        description: 'Scientists in Japan have developed a new battery technology that could double EV range.',
        urlToImage: 'https://images.unsplash.com/photo-1497435334941-8c899ee9e8e9?w=800',
        publishedAt: DateTime.now().subtract(const Duration(hours: 15)).toIso8601String(),
